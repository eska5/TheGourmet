...
class AddLoadImageScreen extends StatefulWidget {
  final PageController controller;
  static Uint8List? pickedImage;

  const AddLoadImageScreen({
    Key? key,
    required this.controller,
  }) : super(key: key);

  @override
  State<AddLoadImageScreen> createState() => _LoadImageScreen();
}

class _LoadImageScreen extends State<AddLoadImageScreen> {
  void callSetState() {
    setState(() {
      if (kDebugMode) {
