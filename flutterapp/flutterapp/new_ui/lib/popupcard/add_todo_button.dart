        ...
        child: Hero(
          ...
          child: Material(
            ...
            child: SizedBox(
              ...
              children: [
              const Icon(Icons.info_outline_rounded, size: 28,color: Colors.white),
              const Text(" Instrukcja",
              style: TextStyle(
                fontSize: 25,
                letterSpacing: 0,
                color: Colors.white,
...
class _AddTodoPopupCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Padding(
        padding: const EdgeInsets.only(left: 32,right: 32, top: 80, bottom: 100),
        child: Hero(
          tag: _heroAddTodo,
          createRectTween: (begin, end) {
            return CustomRectTween(begin: begin!, end: end!);
            ...
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                padding: EdgeInsets.only(left: 15, right: 15, top: 20, bottom:20), //apply padding to all four sides
               ...
               Padding(
                ...
                Padding(
                padding: EdgeInsets.only(left: 15, right: 15, top: 15, bottom: 15), //apply padding to all four sides
                child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () =>  Navigator.pop(context, _AddTodoPopupCard()),
                    ),
                  ),
                )
