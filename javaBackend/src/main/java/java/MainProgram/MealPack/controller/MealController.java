package java.MainProgram.MealPack.controller;

import java.MainProgram.MealPack.DTO.CreateMeal;
import java.MainProgram.MealPack.DTO.ReadAllMeals;
import java.MainProgram.MealPack.DTO.ReadMeal;
import java.MainProgram.MealPack.DTO.UpdateMeal;
   ...
   private final MealService mealService;
    ...
    public ResponseEntity<Void> createMeal(@RequestBody CreateMeal request, UriComponentsBuilder builder) {
        meal meal = CreateMeal
                .dtoToEntityMapper(mealName -> mealService.find(request.getMealId()).orElseThrow())
                .apply(request);
