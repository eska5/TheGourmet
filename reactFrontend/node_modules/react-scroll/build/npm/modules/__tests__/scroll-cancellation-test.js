      ...
      var TestComponent = function (_React$Component) {
        ...
        _createClass(TestComponent, [{
          ...
          value: function render() {
            return _react2.default.createElement('div', null, _react2.default.createElement('input', { onKeyDown: this.handleKeyDown }), _react2.default.createElement('div', { style: { height: "3000px", width: "100%", background: "repeating-linear-gradient(to bottom, white, black 100px)" } }));
          }
        }]);
    ...
    it("can scroll on keydown multiple times in a row", function (done) {
      ...
      var TestComponent = function (_React$Component2) {
        ...
        _createClass(TestComponent, [{
          key: 'render',
          value: function render() {
            return _react2.default.createElement('div', null, _react2.default.createElement('input', { onKeyDown: this.handleKeyDown }), _react2.default.createElement('div', { style: { width: "3000px", height: "100%", background: "repeating-linear-gradient(to right, white, black 100px)" } }));
          }
        }]);
