...
if __name__ == '__main__':
    ...
    transform = transforms.Compose(
        [transforms.RandomRotation(30), transforms.RandomHorizontalFlip(), transforms.RandomAffine(15), transforms.ToTensor()])
    ...
    traindataloader = torch.utils.data.DataLoader(
        datasetTrain, batch_size=32, shuffle=True, num_workers=16, pin_memory=True)

    validationdataloader = torch.utils.data.DataLoader(
        datasetValidation, batch_size=32, shuffle=True, num_workers=16, pin_memory=True)
